...
CHALLENGES INDEX
    ...
    *FU: Follow-Up
    ...
    627. Swap Salary (DML [Updating]: SET / CASE)
    1050. Actors and Directors Who Cooperated At Least Three Times (PAIR GROUPING + HAVING)
    ...
    178. Rank Scores. (Window Func -> Dense_rank())
    180. Consecutive Numbers (SELF JOIN + WHERE conditional)
...
"""
    ...
    """Now say we wanted to recreate this but just showing the result, not altering it"""
    -- SELECT s.id, s.name, s.salary, s.sex,
    -- CASE
    --     WHEN sex = 'f' THEN 'm'
    --     WHEN sex = 'm' THEN 'f'
    --     ELSE 'N/A'
