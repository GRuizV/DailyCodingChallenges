...
- Encryption (Others)
- Bigger is Greater (Permutations) (GRE)
- Modified Kaprekar Numbers (Math)
- Beautiful triplets (Array)
- Minimum Distances (Array) (Hash Table)
- Halloween Sale (GRE) (Sorting)
- The Time in Words (Others)
- Chocolate Feast (Other)
- Service Lane (PS)
- Lisa's Workbook (Array)
- Flatland Space Stations (GRE)
- Fair Rations (GRE)
- Cavity Map (Matrix)
- Manasa and Stones (Math)
- The Grid Search (Matrix)
- Happy Ladybugs (Others)
- Strange Counter (Math)
- Absolute Permutation (Permutation)
- The Bomberman Game (Matrix)
...
#     ''' Notes: This solution is the first draft that came to mind but I'm sure it could be a lot more efficient '''
...
#     'Notes: Brute forcing it wont do, Ill try somehting different'
