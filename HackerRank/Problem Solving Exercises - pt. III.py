...
- Ema's Supercomputer (GRE) (Matrix)
- Classes: Dealing with Complex Numbers (OOP)
- Re.start() & Re.end() (ReGex)
- Classes - Find the Torsional Angle (OOP)
-...
...
#     ''' Notes: My solution up to this point is 36% effective. '''
...
#     'Notes: -Re.start() & Re.end()- HackerRank Problem Solving Challenge done'
